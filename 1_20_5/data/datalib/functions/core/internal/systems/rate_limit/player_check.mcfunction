# datalib:core/internal/systems/rate_limit/player_check — Auto-ensure player bucket if needed [MACRO]
...
$execute if data storage datalib:engine rate_limit.rules.$(ensure_key) run return 0
