# datalib:core/internal/systems/nbt/pop_exec [MACRO]
# INPUT: $(storage), $(path)
...
$tellraw @a[tag=datalib.debug] {"text":"","extra":[{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"nbt/pop ","color":"aqua"},{"text":"$(storage):$(path)","color":"white"}]}
