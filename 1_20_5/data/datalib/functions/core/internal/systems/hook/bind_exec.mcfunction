# datalib:core/internal/systems/hook/bind_exec [MACRO]
...
$tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"hook/bind ","color":"aqua"},{"text":"$(event)","color":"yellow"},{"text":" → ","color":"#555555"},{"text":"$(event)","color":"white"}]
