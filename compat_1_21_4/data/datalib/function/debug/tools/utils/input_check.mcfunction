...
execute if data storage datalib:output inputs{cmd:"&&"} run return 0
execute if data storage datalib:output inputs{cmd:"||"} run return 0
# [1.21.4 compat] removed: execute if data storage datalib:output inputs{cmd:"\n"} run return 0 (SNBT \n not supported)
# [1.21.4 compat] removed: execute if data storage datalib:output inputs{cmd:"\r"} run return 0 (SNBT \r not supported)
# [1.21.4 compat] removed: execute if data storage datalib:output inputs{cmd:"\t"} run return 0 (SNBT \t not supported)
