...
execute if score #dl.dsv dl.tmp matches 600 run data modify storage datalib:engine dev_settings.version set value 117
execute if score #dl.dsv dl.tmp matches 601 run data modify storage datalib:engine dev_settings.version set value 118
execute if score #dl.dsv dl.tmp matches 602 run data modify storage datalib:engine dev_settings.version set value 119
execute if score #dl.dsv dl.tmp matches 603 run data modify storage datalib:engine dev_settings.version set value 120
execute if score #dl.dsv dl.tmp matches 504 run data modify storage datalib:engine dev_settings.version set value 116
