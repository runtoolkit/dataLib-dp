tellraw @a ["",{"text":"❌ ","color":"red"},{"text":"[DL] ","color":"aqua","bold":true},{"text":"Version conflict! ","color":"red","bold":true},{"text":"Expected ","color":"gray"},{"text":"v6.0.1-pre1","color":"yellow","bold":true},{"text":" — stored scores do not match.","color":"gray"}]
...
data modify storage datalib:engine _log_add_tmp.message set value "❌ Version mismatch — expected v6.0.1-pre1. Load aborted."
