...
#
# Usage:
#   function datalib:runtime/queue/flush

execute if data storage datalib:engine work_queue[0] run function datalib:runtime/queue/internal/flush_loop
