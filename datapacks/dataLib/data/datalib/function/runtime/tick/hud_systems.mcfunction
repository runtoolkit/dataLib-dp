...
execute if data storage datalib:engine pb_obj run execute if score $pb_mod dl.tmp matches 0 run execute as @a run function datalib:modules/string/api/progress_bar_self with storage datalib:engine {}
