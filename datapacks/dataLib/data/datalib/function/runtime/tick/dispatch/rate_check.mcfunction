...
execute if data storage datalib:tick_work channel{condition:""} run function datalib:runtime/tick/dispatch/exec with storage datalib:tick_work channel
execute unless data storage datalib:tick_work channel{condition:""} run function datalib:runtime/tick/dispatch/exec2 with storage datalib:tick_work channel