# datalib:runtime/security/multi_type_check_macro [MACRO]
...
# "function datalib:runtime/security/type_violation" or "datalib:core/empty",
...
$execute unless data storage datalib:engine security.multi_type_allowlist{$(_mcmd_type_tmp):1b} run function datalib:runtime/security/type_violation
