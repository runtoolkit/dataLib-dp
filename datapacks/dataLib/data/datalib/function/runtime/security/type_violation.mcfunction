# datalib:runtime/security/type_violation
...
execute if score #dl.log_level dl.log_level matches 2.. run function datalib:debug/menu/log/add with storage datalib:engine _log_add_tmp
...
function datalib:runtime/security/type_violation/notify_admins with storage datalib:input {}
