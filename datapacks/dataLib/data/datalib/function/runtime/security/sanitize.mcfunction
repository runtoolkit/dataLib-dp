# ======================================================================================
# datalib:runtime/security/sanitize
# ======================================================================================
#
# PURPOSE:
...
#
# WHY THIS DOES NOT CALL datalib:modules/string/api/legacy/to_lowercase OR datalib:modules/string/api/legacy/replace:
#   Both depend on datalib:modules/string/internal/legacy/to_lowercase/* and zprivate/replace/*,
...
#   confirmed working here, datalib:modules/string/api/legacy/concat.
#
...
#   function datalib:runtime/security/sanitize
...
function datalib:runtime/security/sanitize_priv/lower_loop
...
function datalib:runtime/security/sanitize_priv/filter_loop

# Reassemble via the one stringlib primitive verified working in this pack.
data modify storage datalib:stringlib_data.input concat set from storage datalib:output _sf.Filtered
function datalib:modules/string/api/legacy/concat
data modify storage datalib:output sanitize set from storage datalib:stringlib_data.output concat
