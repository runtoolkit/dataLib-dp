# ======================================================================================
# datalib:runtime/security/namespace_allowlist_loop
# ======================================================================================
#
# PURPOSE:
#   Tests inputs.func against each prefix in datalib:output _ns.List
#   (populated by input_check Section 5 from datalib:api/config/namespace_list).
...
data modify storage datalib:stringlib_data.input find.String set from storage datalib:output inputs.func
data modify storage datalib:stringlib_data.input find.Find set from storage datalib:output _ns.List[0]
...
execute if score #DL.NsPrefixOk dl.tmp matches 0 run function datalib:runtime/security/namespace_allowlist_loop
