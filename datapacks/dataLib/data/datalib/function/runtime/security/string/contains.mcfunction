# ======================================================================================
# datalib:runtime/security/string/contains
# ======================================================================================
#
# PURPOSE:
...
#   Only datalib:modules/string/internal/legacy/concat and datalib:modules/string/internal/legacy/find ship in this
...
#   (see datalib:runtime/security/sanitize header comment for the same
#   finding). find + concat are the only verified-working primitives,
#   so all matching here is built on find alone.
#
# ISOLATION:
#   Uses datalib:stringlib_data.input/output find — the same storage StringLib itself
...
execute store result score #DL.StrIndex dl.tmp run data get storage datalib:stringlib_data.output find[0]
