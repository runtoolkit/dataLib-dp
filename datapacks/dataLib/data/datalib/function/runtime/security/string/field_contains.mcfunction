# ======================================================================================
# datalib:runtime/security/string/field_contains
# ======================================================================================
#
# PURPOSE:
#   Macro wrapper around datalib:runtime/security/string/contains, specialized
...
$data modify storage datalib:stringlib_data.input find.String set from storage datalib:output inputs.$(field)
$data modify storage datalib:stringlib_data.input find.Find set value "$(needle)"
...
$execute unless data storage datalib:output inputs.$(field) run data remove storage datalib:stringlib_data.input find
$execute unless data storage datalib:output inputs.$(field) run return 0

function datalib:runtime/security/string/contains
