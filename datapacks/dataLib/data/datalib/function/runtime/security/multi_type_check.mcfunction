# datalib:runtime/security/multi_type_check
...
# "execute if/unless function datalib:runtime/security/multi_type_check"
...
return run function datalib:runtime/security/multi_type_check_macro with storage datalib:engine {}
