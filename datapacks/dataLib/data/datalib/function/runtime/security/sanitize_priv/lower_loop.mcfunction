# ======================================================================================
# datalib:runtime/security/sanitize_priv/lower_loop
# ======================================================================================
#
...
#   datalib:modules/string/api/legacy/to_lowercase/fast depends on datalib:modules/string/internal/legacy/to_lowercase/
