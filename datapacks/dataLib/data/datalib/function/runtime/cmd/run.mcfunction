...
#
# Available types: see datalib:debug/menu/tools/trigger/internal/dispatch for full list.
# Examples:
...
execute if data storage datalib:input cmd run function datalib:runtime/cmd/exec
