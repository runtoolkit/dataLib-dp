# datalib:runtime/disable — Dangerous command (confirmation gate required)
#
...
#   /function datalib:runtime/load/loader/gate/yes
#
# To cancel:
#   /function datalib:runtime/load/loader/gate/no
#
