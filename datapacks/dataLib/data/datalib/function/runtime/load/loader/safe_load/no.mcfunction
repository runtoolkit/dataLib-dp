# datalib:runtime/load/loader/safe_load/no
# Enhanced load cancellation with detailed logging.
# Use INSTEAD OF datalib:runtime/load/loader/load/no for audited environments.
#
# USAGE:
#   /function datalib:runtime/load/loader/safe_load/no
...
function datalib:runtime/load/loader/load/no
