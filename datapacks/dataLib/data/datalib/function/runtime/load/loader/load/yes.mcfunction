# datalib:runtime/load/loader/load/yes
...
#   4. Schedule datalib:runtime/load/loader/load/all at t+1 (clean tick boundary)
#
# The 1-tick delay lets the scoreboard objective removal settle before
# datalib:runtime/load/loader/loader/scoreboards runs and recreates its own objectives.
...
# datalib:runtime/load/loader/loader/scoreboards recreates its objectives
schedule function datalib:runtime/load/loader/load/all 1t replace
