# datalib:runtime/load/loader/load/fork
# Fork confirmation gate — called when fork_verified is not set.
# Player is prompted to confirm with a click or /yes-/no command.
#
# USAGE:
#   /function datalib:runtime/load/loader/load/fork
#
# CONFIRM:  /function datalib:runtime/load/loader/load/fork_yes  (or click [Yes])
# CANCEL:   /function datalib:runtime/load/loader/load/fork_no   (or click [No])
...
tellraw @a ["",{"text":"[DL FORK GATE] ","color":"#555555"},{"text":"[Yes]","color":"green","bold":true,"underlined":true,"click_event":{"action":"run_command","command":"/function datalib:runtime/load/loader/load/fork_yes"}},{"text":"   ","color":"gray"},{"text":"[No]","color":"red","bold":true,"underlined":true,"click_event":{"action":"run_command","command":"/function datalib:runtime/load/loader/load/fork_no"}}]
tellraw @a ["",{"text":"[DL FORK GATE] ","color":"#555555"},{"text":"Auto-cancel fires in 30 seconds.","color":"gray"}]

schedule function datalib:runtime/load/loader/load/fork_no 30s replace
