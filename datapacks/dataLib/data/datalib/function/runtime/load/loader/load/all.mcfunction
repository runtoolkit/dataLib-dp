# datalib:runtime/load/loader/load/all
# Load — entry point called from minecraft:load tag via datalib:runtime/load/load
#
...
execute unless function datalib:runtime/load/loader/resolve/validate run return 0
...
execute unless data storage datalib:engine global.fork_verified run return run function datalib:runtime/load/loader/load/fork

tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"Fork gate passed...","color":"gray"}]

# Stage 2 — scoreboards (moved to loader/ — see datalib:runtime/load/loader/loader/scoreboards)
tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"Loading scoreboards...","color":"gray"}]
function datalib:runtime/load/loader/loader/scoreboards

# Stage 3 — storages (moved to loader/ — see datalib:runtime/load/loader/loader/storages)
tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"Loading storages...","color":"gray"}]
function datalib:runtime/load/loader/loader/storages

tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"Loading other systems...","color":"gray"}]

function datalib:runtime/load/loader/load/other

data modify storage datalib:engine global.loaded set value 1b

function datalib:runtime/load/loader/core/internal/load/version_set
...
function datalib:runtime/load/loader/core/internal/load/finalize
