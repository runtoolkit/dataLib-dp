# datalib:runtime/load/loader/safe_load/yes
# Enhanced load confirmation gate with additional security precautions.
# Use INSTEAD OF datalib:runtime/load/loader/load/yes when operating in a security-critical context.
#
...
#
# USAGE:
#   /function datalib:runtime/load/loader/safe_load/yes
...
execute unless entity @s[type=minecraft:player] run function datalib:runtime/load/loader/load/yes
...
function datalib:runtime/load/loader/load/yes
