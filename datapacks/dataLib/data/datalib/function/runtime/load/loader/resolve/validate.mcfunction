# datalib:runtime/load/loader/resolve/validate
# Returns 1 → validation passed, load continues.
# Returns 0 → validation failed, load aborted.
#
# v6.0.1: split out of the old monolithic
# core/internal/load/validate.mcfunction into datalib:runtime/load/loader/resolve/* —
# version compatibility and dependency resolution are distinct
# concerns and are now separately testable/callable:
#   datalib:runtime/load/loader/resolve/version       — stale-scoreboard version match
#   datalib:runtime/load/loader/resolve/dependencies  — rt_origin/fork + StringLib
...
# ── Version resolution ───────────────────────────────────────────
execute unless function datalib:runtime/load/loader/resolve/version run return 0

# ── Dependency resolution (fork/origin + StringLib) ──────────────
function datalib:runtime/load/loader/resolve/dependencies
