# datalib:runtime/load/loader/main — Stage 0 Load Entry Point
#
# This is the ONLY function registered in the minecraft:load function tag
# (via datalib:runtime/load/load → datalib:runtime/load/loader/main).
...
#
# v6.0.1: renamed from datalib:runtime/load/loader/main to datalib:runtime/load/loader/main, and dropped the
...
#     datalib:runtime/load/loader/load/confirm for the actual button rendering.
#
...
#     touch.
#
# CONFIRMING:  /function datalib:runtime/load/loader/load/yes  (or click the button)
# CANCELLING:  /function datalib:runtime/load/loader/load/no   (or click the button)
# AUTO-CANCEL: fires after 5 minutes if no response

function datalib:runtime/load/loader/load/confirm
