# datalib:runtime/load/loader/loader/storages
# Initializes datalib:engine storage fields that do not yet exist.
# (moved from datalib:runtime/load/loader/load/storages in v6.0.1 — load/ vs loader/
...
#   (b) was cleanly disabled via datalib:runtime/disable (cleanup removed global).
...
# UUID module init
function datalib:modules/uuid/internal/init
...
# from datalib:runtime/disable — never from the /reload path (load/all.mcfunction
...
#                          via /function datalib:debug/menu/tools/admin/debug_tag/*
...
#                          /function datalib:debug/menu/tools/log/enable (or disable).
# ─────────────────────────────────────────────────────────────────
...
# then /function datalib:debug/menu/testblock/place to (re)place the block
...
# ─────────────────────────────────────────────────────────────────
function datalib:modules/color/api/init
