# datalib:runtime/load/loader/resolve/version
...
execute if score #dl.mismatch dl.pre_version matches 1 run function datalib:runtime/load/loader/core/internal/load/version_warn
