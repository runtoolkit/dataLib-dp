# datalib:runtime/load/loader/gate/request
...
#   function datalib:runtime/load/loader/gate/request
#
# This function then:
...
#
# CONFIRMING:  /function datalib:runtime/load/loader/gate/yes  (or click [Confirm])
# CANCELLING:  /function datalib:runtime/load/loader/gate/no   (or click [Cancel])
#
...
tellraw @a ["",{"text":"[DL GATE] ","color":"#555555"},{"text":"[Confirm]","color":"green","bold":true,"underlined":true,"click_event":{"action":"run_command","command":"/function datalib:runtime/load/loader/gate/yes"}},{"text":"   ","color":"gray"},{"text":"[Cancel]","color":"red","bold":true,"underlined":true,"click_event":{"action":"run_command","command":"/function datalib:runtime/load/loader/gate/no"}}]
...
schedule function datalib:runtime/load/loader/gate/timeout 30s replace
