# datalib:runtime/load/loader/timeout
# Fires 5 minutes after datalib:runtime/load/loader/load/confirm if no admin response.
#
...
#
# Delegates to datalib:runtime/load/loader/load/no which is idempotent — if the admin
...
execute if score #pending dl.load matches 1 run function datalib:runtime/load/loader/load/no
