# ─────────────────────────────────────────────
# datalib:runtime/engine/call/execute_validated
# Runs a function that has passed security validation.
# Called only by datalib:debug/menu/tools/utils/input_check.
#
...
function datalib:runtime/engine/call/execute_validated/run with storage datalib:output inputs
