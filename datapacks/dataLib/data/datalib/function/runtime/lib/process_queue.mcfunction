...
execute if score $qdel dl.tmp matches ..0 run function datalib:runtime/lib/internal/queue_fire
execute if score $qdel dl.tmp matches ..0 run function datalib:runtime/lib/process_queue
