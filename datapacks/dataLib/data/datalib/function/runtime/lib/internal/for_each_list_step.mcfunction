...
function datalib:runtime/lib/internal/for_each_list_call with storage datalib:engine _felist_state

data remove storage datalib:engine _felist_input[0]
scoreboard players add $felist_i dl.tmp 1

function datalib:runtime/lib/internal/for_each_list_step
