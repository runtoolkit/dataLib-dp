...
execute if score #cb_tl dl.tmp matches ..0 run function datalib:internal/cb/tick/fire_entry
...
execute if data storage datalib:engine _cb_work[0] run function datalib:internal/cb/tick/process_step
