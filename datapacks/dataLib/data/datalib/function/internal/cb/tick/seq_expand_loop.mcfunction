...
# Write queue entry
function datalib:internal/cb/tick/seq_push_entry

# Continue if more cmds remain
execute if data storage datalib:engine _cb_seq.cmds[0] run function datalib:internal/cb/tick/seq_expand_loop
