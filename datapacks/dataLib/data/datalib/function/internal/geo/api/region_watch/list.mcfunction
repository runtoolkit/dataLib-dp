# ─────────────────────────────────────────────────────────────────
# datalib:internal/geo/api/region_watch/list
...
execute if data storage datalib:engine region_watches run tellraw @a[tag=datalib.debug] ["",{"text":" ","color":"#555555"},{"plain":true ,"storage":"datalib:engine","nbt":"region_watches","interpret":false,"color":"yellow"}]
