...
function datalib:internal/cmd/other/multi_cmd/exec_func with storage datalib:engine _mcmd_entry

function datalib:internal/cmd/other/multi_cmd/step_func
