...
execute if data storage datalib:engine _mcmd_current{} run function datalib:internal/cmd/other/multi_cmd/exec_object
execute unless data storage datalib:engine _mcmd_current{} run function datalib:internal/cmd/other/multi_cmd/exec_string

data remove storage datalib:engine _mcmd_current

# Continue draining the queue — schedule next tick
execute if data storage datalib:engine _mcmd_queue[0] run schedule function datalib:internal/cmd/other/multi_cmd/advanced/run_spread_tick 1t append
