...
# cache position
data modify storage datalib:player_action_data.temp list set from entity @s Pos

# calc difference
execute store result score #x player_action.data run data get storage datalib:player_action_data.temp list[0] 70
...
execute store result score #y player_action.data run data get storage datalib:player_action_data.temp list[1] 70
...
execute store result score #z player_action.data run data get storage datalib:player_action_data.temp list[2] 70
