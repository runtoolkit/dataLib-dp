# datalib:internal/rate_limit/api/channel/check — Per-channel rate guard [MACRO]
#
...
# function datalib:internal/rate_limit/api/channel/check {id:"my_channel"}
...
$function datalib:internal/rate_limit/api/check {key:"channel:$(id)"}
