...
execute if score $ptd_val dl.tmp = $ptd_entry_val dl.tmp run function datalib:internal/perm/trigger/run_if_perm with storage datalib:engine _ptd_current

function datalib:internal/perm/trigger/check_bind
