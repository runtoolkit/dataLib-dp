# datalib:internal/hook/api/list
...
execute if data storage datalib:engine hook_binds[0] run tellraw @a[tag=datalib.debug] ["",{"text":" ","color":"#555555"},{"plain":true ,"storage":"datalib:engine","nbt":"hook_binds","interpret":false,"color":"yellow"}]
