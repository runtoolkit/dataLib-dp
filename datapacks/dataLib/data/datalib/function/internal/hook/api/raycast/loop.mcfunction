...
execute unless block ~ ~ ~ #minecraft:air run return run function datalib:internal/hook/api/raycast/found
...
execute positioned ^ ^ ^0.1 run function datalib:internal/hook/api/raycast/loop
