# ─────────────────────────────────────────────────────────────────
# datalib:internal/hook/api/on_advancement_fire
...
# function datalib:internal/hook/api/on_advancement_fire
#
# 3) Hook bind:
...
function datalib:internal/hook/on_advancement_fire with storage datalib:input {}
