...
# player_join — delegated to #datalib:player_action/v1/joined (fired by player_action when player_action.join >= 1)
# Only score management remains here to prevent double-fire
execute as @a run scoreboard players set @s datalib.hook_online 1

# player_death — delegated to #datalib:player_action/v1/died (fired by player_action when player_action.death >= 1)
...
execute as @a[tag=datalib.hook_dead,nbt={DeathTime:0s}] run function datalib:internal/hook/on_player_respawn
...
execute as @a run function datalib:internal/hook/check_level_up

# block_place — advancement-based, placed_blocks score increase
execute as @a[scores={datalib.hook_placed=1..}] run function datalib:internal/hook/on_block_place
...
execute as @a run function datalib:internal/hook/check_block_break

# item_use — advancement-based, score increase
execute as @a[scores={datalib.hook_item_used=1..}] run function datalib:internal/hook/on_item_use
...
execute as @a[scores={datalib.hook_entity_killed=1..}] run function datalib:internal/hook/on_entity_kill
...
execute as @a[scores={datalib.hook_using_item=1..}] run function datalib:internal/hook/on_using_item
...
execute as @a[scores={datalib.hook_killed_by_arrow=1..}] run function datalib:internal/hook/on_killed_by_arrow
...
execute as @a[scores={datalib.hook_hero_of_the_village=1..}] run function datalib:internal/hook/on_hero_of_the_village
...
execute as @a[scores={datalib.hook_sneak=..0},predicate=datalib:is_sneaking] run function datalib:internal/hook/on_sneak_start
execute as @a[scores={datalib.hook_sneak=1},predicate=!datalib:is_sneaking] run function datalib:internal/hook/on_sneak_stop
...
execute as @a[scores={datalib.hook_sprint=..0},predicate=datalib:is_sprinting] run function datalib:internal/hook/on_sprint_start
execute as @a[scores={datalib.hook_sprint=1},predicate=!datalib:is_sprinting] run function datalib:internal/hook/on_sprint_stop
...
execute as @a[scores={datalib.hook_elytra=..0},predicate=datalib:is_gliding] run function datalib:internal/hook/on_elytra_start
execute as @a[scores={datalib.hook_elytra=1},predicate=!datalib:is_gliding] run function datalib:internal/hook/on_elytra_stop
...
execute as @a[scores={datalib.hook_dim_changed=1..}] run function datalib:internal/hook/on_dimension_change
execute as @a[scores={datalib.hook_dim_changed=1..}] run scoreboard players set @s datalib.hook_dim_changed 0

execute as @a[scores={datalib.hook_traded=1..}] run function datalib:internal/hook/on_trade
execute as @a[scores={datalib.hook_traded=1..}] run scoreboard players set @s datalib.hook_traded 0

# jumped — delegated to #datalib:player_action/v1/jumped (fired by player_action when player_action.jump >= 1)
# Only score reset remains here to prevent double-fire
...
execute as @a[scores={datalib.hook_open_chest=1..}] run function datalib:internal/hook/on_open_chest
...
execute as @a[scores={datalib.hook_drop=1..}] run function datalib:internal/hook/on_drop
...
execute as @a[scores={datalib.hook_target_hit=1..}] run function datalib:internal/hook/on_target_hit
...
execute as @a[scores={datalib.hook_eat=1..}] run function datalib:internal/hook/on_eat_fire
...
execute as @a[scores={datalib.hook_fish=1..}] run function datalib:internal/hook/on_fish_fire
