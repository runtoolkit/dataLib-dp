# datalib:debug/menu/log/debug
# Usage: $function datalib:debug/menu/log/debug {message:"[System] Trace detail"}
...
execute if score #dl.log_level dl.log_level matches 4.. run function datalib:debug/menu/log/add with storage datalib:engine _log_add_tmp
