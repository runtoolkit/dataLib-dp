...
data modify storage datalib:input func set value "datalib:debug/menu/log/internal/print_entry"
function datalib:runtime/lib/for_each_list with storage datalib:input {}
