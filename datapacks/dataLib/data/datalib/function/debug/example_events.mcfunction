...
data modify storage datalib:input func set value "datalib:debug/menu/internal/on_join_handler"
function datalib:api/events/register with storage datalib:input {}

data modify storage datalib:input event set value "on_kill"
data modify storage datalib:input func set value "datalib:debug/menu/internal/on_kill_handler"
function datalib:api/events/register with storage datalib:input {}
...
data modify storage datalib:input event set value "on_join"
function datalib:api/events/fire with storage datalib:input {}
