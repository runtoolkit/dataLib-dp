# datalib:debug/menu/testblock/pulse [MACRO]
...
#
# Read position fresh each call so datalib:debug/menu/testblock/place
...
function datalib:debug/menu/testblock/pulse_at with storage datalib:tick_work testblock
...
schedule function datalib:debug/menu/testblock/unpulse_at 1t replace
