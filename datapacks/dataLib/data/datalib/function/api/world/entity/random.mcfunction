# ─────────────────────────────────────────────────────────────────
# datalib:api/world/entity/random
...
#
# EXAMPLE:
#   function datalib:api/world/entity/random {type:"minecraft:zombie",tag:"mob.active",func:"mypack:reward"}
# ─────────────────────────────────────────────────────────────────
...
$execute as @e[type=$(type),tag=$(tag)] run function datalib:runtime/dispatch/entity/random_assign
...
function datalib:runtime/dispatch/entity/random_dispatch with storage datalib:engine _rnd
