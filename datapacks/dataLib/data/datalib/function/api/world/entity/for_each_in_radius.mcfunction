# ─────────────────────────────────────────────────────────────────
# datalib:api/world/entity/for_each_in_radius
...
#
# EXAMPLE:
# function datalib:api/world/entity/for_each_in_radius {player:"Steve",type:"minecraft:zombie",radius:10,func:"mypack:on_zombie"}
# ─────────────────────────────────────────────────────────────────
