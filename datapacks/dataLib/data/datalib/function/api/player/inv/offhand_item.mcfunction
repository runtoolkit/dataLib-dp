# ─────────────────────────────────────────────────────────────────
# datalib:api/player/inv/offhand_item
# Runs a command/function for each player in @a whose offhand
# matches the given item id and custom data.
# Mirrors the pattern of datalib:api/player/inv/selected_item (mainhand).
#
...
#
# EXAMPLE:
# function datalib:api/player/inv/offhand_item {item:"minecraft:shield",customData:"{my_tag:1b}",invoke:"function mypack:on_shield"}
# ─────────────────────────────────────────────────────────────────
