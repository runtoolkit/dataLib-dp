# ======================================================================================
# datalib:api/config/namespace_list
# ======================================================================================
#
# PURPOSE:
...
#   3. What is the narrowest possible prefix? Prefer "datalib:modules/string/api/legacy/"
...
data modify storage datalib:output config.namespace_allowlist set value ["datalib:","datalib:runtime/bootstrap/empty"]

# --- Approved additional prefixes go below this line, one per line. ---
# Example (DO NOT UNCOMMENT WITHOUT A REVIEWED PR):
# data modify storage datalib:output config.namespace_allowlist append value "datalib:modules/string/api/legacy/"
