# ======================================================================================
# datalib:api/input/validate/_private/check_float_dot_position  [INTERNAL]
# ======================================================================================
# datalib:stringlib_data.output find holds a one-element list [idx] for the '.' just
...
execute store result score #DL.DotIdx dl.tmp run data get storage datalib:stringlib_data.output find[0]
