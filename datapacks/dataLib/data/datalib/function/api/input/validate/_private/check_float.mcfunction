# ======================================================================================
# datalib:api/input/validate/_private/check_float  [INTERNAL]
# ======================================================================================
...
execute store result score #DL.DotHits dl.tmp run function datalib:modules/string/api/legacy/replace
...
execute if score #DL.DotHits dl.tmp matches 1 run data modify storage datalib:stringlib_data.input find.String set from storage datalib:input_validate scratch.rest
execute if score #DL.DotHits dl.tmp matches 1 run data modify storage datalib:stringlib_data.input find.Find set value "."
execute if score #DL.DotHits dl.tmp matches 1 run data modify storage datalib:stringlib_data.input find.n set value 1
execute if score #DL.DotHits dl.tmp matches 1 run function datalib:modules/string/api/legacy/find
execute if score #DL.DotHits dl.tmp matches 1 run function datalib:api/input/validate/_private/check_float_dot_position
...
execute if score #DL.DotHits dl.tmp matches 1 run function datalib:api/input/validate/_private/strip_one_dot

execute store result score #DL.Len dl.tmp run data get storage datalib:input_validate scratch.rest
execute if score #DL.Len dl.tmp matches 0 run data modify storage datalib:input_validate result.error set value "no digits"
execute if score #DL.Len dl.tmp matches 0 run return 0

function datalib:api/input/validate/_private/count_digits
