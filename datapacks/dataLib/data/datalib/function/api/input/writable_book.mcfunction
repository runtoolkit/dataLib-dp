# ======================================================================================
# datalib:api/input/writable_book
# ======================================================================================
#
# TRIGGERED BY: #datalib:api/input/writable_book function tag
#
# PURPOSE:
...
execute as @a[nbt={SelectedItem:{components:{"minecraft:custom_data":{dataLib:{input:1b}}}}}] run function datalib:api/input/private/book_capture
