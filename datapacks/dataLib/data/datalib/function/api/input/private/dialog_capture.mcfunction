# ======================================================================================
# datalib:api/input/private/dialog_capture  [INTERNAL — do not call directly]
# ======================================================================================
#
...
# datalib:api/input/validate/check before treating it as a number/bool/tag-safe
# literal: function datalib:api/input/validate/check with storage <yourpath> {source:"dialog.raw", type:"int"}
...
execute if data storage datalib:input dialog{executed:0b} run function #datalib:api/input/dialog