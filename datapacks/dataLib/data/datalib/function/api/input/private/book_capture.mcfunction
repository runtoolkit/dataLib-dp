# ======================================================================================
# datalib:api/input/private/book_capture  [INTERNAL — do not call directly]
# ======================================================================================
#
...
# run it through datalib:api/input/validate/check first:
#   function datalib:api/input/validate/check with storage <yourpath> {source:"book.raw", type:"int"}
# ======================================================================================
...
execute if data storage datalib:input book{executed:0b} run function #datalib:api/input/writable_book
