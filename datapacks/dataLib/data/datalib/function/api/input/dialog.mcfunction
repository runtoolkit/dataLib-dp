# ======================================================================================
# datalib:api/input/dialog
# ======================================================================================
#
# TRIGGERED BY: #datalib:api/input/dialog function tag
#
# PURPOSE:
#   Opens datalib:input_prompt dialog for @s (must be run 'as' a player,
#   e.g. 'execute as <player> run function datalib:api/input/dialog', or bound
#   to a right-click/other trigger by the caller). Submitted text lands in
#   datalib:input_prompt's action, which macro-calls
#   datalib:api/input/private/dialog_capture — capture only, no execution.
#
