...
# Cleanup
function datalib:internal/cmd/other/multi_cmd/cleanup

# Show statistics
execute if data storage datalib:engine _mcmd_options{profile:1b} run function datalib:internal/cmd/other/multi_cmd/show_stats
