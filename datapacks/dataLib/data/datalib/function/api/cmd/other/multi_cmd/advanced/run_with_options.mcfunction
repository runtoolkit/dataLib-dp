...
execute if data storage datalib:engine _mcmd_options.type run execute unless function datalib:runtime/security/multi_type_check run return 0
...
execute if data storage datalib:engine _mcmd_options{priority_sort:1b} run function datalib:internal/cmd/other/multi_cmd/advanced/sort_by_priority
execute if data storage datalib:engine _mcmd_options.spread_ticks unless data storage datalib:engine _mcmd_options{spread_ticks:0} run return run function datalib:internal/cmd/other/multi_cmd/advanced/run_spread
