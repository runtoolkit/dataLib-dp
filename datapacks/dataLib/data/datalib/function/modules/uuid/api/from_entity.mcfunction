# ============================================================
# datalib:modules/uuid/api/from_entity
# Converts the current entity's (@s) UUID to a hex string
#
# KULLANIM:
# execute as <entity> run function datalib:modules/uuid/api/from_entity
#
# OUTPUT:
...
function datalib:modules/uuid/internal/extract_bytes
function datalib:modules/uuid/internal/get_hexes with storage datalib:uuid _tmp
function datalib:modules/uuid/internal/concat with storage datalib:uuid _tmp
