# ─────────────────────────────────────────────────────────────────
# datalib:modules/string/api/format_coords
...
#   function datalib:modules/string/api/format_coords {x:100,y:64,z:-200}
#   tellraw @a ["",
#     {"text":"(","color":"gray"},
#     {"plain":true ,"storage":"datalib:output","nbt":"x","color":"green"},
#     {"text":", ","color":"gray"},
#     {"plain":true ,"storage":"datalib:output","nbt":"y","color":"green"},
#     {"text":", ","color":"gray"},
#     {"plain":true ,"storage":"datalib:output","nbt":"z","color":"green"},
#     {"text":")","color":"gray"}
#   ]
#   → (100, 64, -200)
#
...
tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"string/format_coords ","color":"aqua"},{"text":"(","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"x","color":"#aaffaa"},{"text":", ","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"y","color":"#aaffaa"},{"text":", ","color":"#555555"},{"plain":true ,"storage":"datalib:output","nbt":"z","color":"#aaffaa"},{"text":")","color":"#555555"}]
