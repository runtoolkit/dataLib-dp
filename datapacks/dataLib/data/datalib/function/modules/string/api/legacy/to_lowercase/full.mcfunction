...
##         Example: "ABC" => "abc"                                                                      ##
##                                                                                                      ##
## The output is found in the 'datalib:stringlib_data.output to_lowercase' data storage                              ##
##########################################################################################################
...
function datalib:modules/string/internal/legacy/to_lowercase/main_full with storage datalib:stringlib_data.temp data
...
data modify storage datalib:stringlib_data.output to_lowercase set from storage datalib:stringlib_data.output concat
