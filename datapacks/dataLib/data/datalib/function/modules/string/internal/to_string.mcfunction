# datalib:modules/string/internal/to_string
...
function datalib:runtime/lib/internal/string/to_string_dispatch with storage datalib:engine _str_bridge
data modify storage datalib:output string.result set from storage datalib:stringlib_data.output to_string
