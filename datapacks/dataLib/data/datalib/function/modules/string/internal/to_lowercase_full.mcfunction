# datalib:modules/string/internal/to_lowercase_full
...
function datalib:runtime/lib/internal/string/to_lower_full_dispatch with storage datalib:engine _str_bridge
