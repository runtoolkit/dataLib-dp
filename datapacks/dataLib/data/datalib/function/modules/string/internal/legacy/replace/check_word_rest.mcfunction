...
data modify storage datalib:stringlib_data.temp data.CheckString.String set string storage datalib:stringlib_data.temp data.String 1
data modify storage datalib:stringlib_data.temp data.CheckString.Find set string storage datalib:stringlib_data.input replace.Find 1
