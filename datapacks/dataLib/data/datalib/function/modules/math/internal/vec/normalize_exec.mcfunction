...
tellraw @a[tag=datalib.debug] ["",{"text":"[DL] ","color":"#00AAAA","bold":true},{"text":"math/vec/normalize ","color":"aqua"},{"text":"len=","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"length","color":"yellow"},{"text":" → ","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"x","color":"yellow"},{"text":",","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"y","color":"yellow"},{"text":",","color":"gray"},{"plain":true ,"storage":"datalib:output","nbt":"z","color":"yellow"}]
