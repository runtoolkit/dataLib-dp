# datalib:tooling/security_menu/menu  [1.21.6 OVERLAY]
...
execute unless function datalib:debug/menu/tools/utils/perm_check run return 0
...
function datalib:tooling/security_menu/menu_build with storage datalib:input {}
